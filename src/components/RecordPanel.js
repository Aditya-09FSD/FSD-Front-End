...
function RecordPanel() {
  ...
  const addTimetableEntry = () => {
    setForm({
      ...form,
      timetable: [...form.timetable, { subject: '', teacher: '', location: '', timing: '' }],
    });
  };
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2">Students:</label>
            <select
              multiple
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2">Teachers:</label>
            <select
              multiple
              ...
              onChange={(e) =>
                setForm({
                  ...form,
                  selectedTeachers: Array.from(e.target.selectedOptions, (option) => option.value),
                })
              }
              className="border border-gray-300 rounded-lg p-2 w-full focus:ring focus:ring-blue-200"
            >
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2">Timetable:</label>
