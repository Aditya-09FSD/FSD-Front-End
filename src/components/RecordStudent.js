  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-xl rounded-lg p-8 w-full max-w-3xl transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-2xl relative">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Record Student</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block font-semibold text-gray-700 mb-2">PRN:</label>
            <input
              type="number"
              name="prn"
              value={form.prn}
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2">Panel:</label>
            <input
              type="text"
              name="panel"
              value={form.panel}
          ...
          <button type="submit" className="w-full p-3 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300">
            Submit
          </button>
        </form>
      </div>
